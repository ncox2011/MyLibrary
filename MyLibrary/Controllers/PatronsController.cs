...
namespace MyLibrary.Controllers
{
    public class PatronsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("PatronId,FirstName,LastName,Address,LibraryCardNum")] Patron patron)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PatronId,FirstName,LastName,Address,LibraryCardNum")] Patron patron)
        {
